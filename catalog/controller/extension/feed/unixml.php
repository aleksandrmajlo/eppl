...
class ControllerExtensionFeedUnixml extends Controller {
  ...
  public $ext = 'unixml';
  public $path = 'extension/feed/unixml';
  public $model_path = 'model_extension_feed_unixml';
  public $feed = '';
  public $secret = '';
  public $start = '';
  public $mem_start = '';
  ...
  public function yandex() {
    ...
    if($startup['status']){
      ...
      if(isset($product['delivery_time'])){ //delivery_time
        $startup['delivery_time'] = $product['delivery_time'];
      }

      if(isset($product['delivery_cost'])){ //delivery_cost
        $startup['delivery_cost'] = $product['delivery_cost'];
      }
