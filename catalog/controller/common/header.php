...
class ControllerCommonHeader extends Controller
{
	public function index()
	{
		...
		// !!!!!!!!!
		$data['menuMobile'] = $this->load->controller('common/menuMobile');
        $data['dellivery'] = $this->url->link('information/information', 'information_id=' . 6);
        $data['garantii'] = $this->url->link('information/information', 'information_id=' . 5);
        $data['about'] = $this->url->link('information/information', 'information_id=' . 4);

        if (isset($this->request->get['product_id'])) {
            $data['bodyclass']='product_id';
        } elseif (isset($this->request->get['path'])) {
            $data['bodyclass']='catalogPage';
        } elseif (isset($this->request->get['manufacturer_id'])) {
            $data['bodyclass']='manufacturer';
