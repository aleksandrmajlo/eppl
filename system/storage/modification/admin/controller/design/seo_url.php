...
class ControllerDesignSeoUrl extends Controller {
	...
	protected function getList() {
		...
		$data['sort_route'] = $this->url->link('design/seo_url', 'user_token=' . $this->session->data['user_token'] . '&sort=route' . $url, true);
	...
	protected function validateForm() {
		...
		if (in_array($this->request->post['route'], array('product/product', 'product/category', 'product/manufacturer/info', 'information/information', 'extension/d_blog_module/post', 'extension/d_blog_module/category')) && !$this->request->post['query']) {
