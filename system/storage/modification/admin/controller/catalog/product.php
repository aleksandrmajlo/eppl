...
class ControllerCatalogProduct extends Controller
{
    ...
    // OCFilter end
		...
		// по цвету
		if (isset($this->request->post['product_related_color'])) {
			$products = $this->request->post['product_related_color'];
		} elseif (isset($this->request->get['product_id'])) {
			$products = $this->model_catalog_product->getProductRelatedColor($this->request->get['product_id']);
		} else {
			$products = array();
		}
		$data['product_relateds_color'] = array();
		foreach ($products as $product_id) {
			$related_info = $this->model_catalog_product->getProduct($product_id);
       ...
       // по цвету !!!!!!!!!!!!!!!!!!!!!!!
		...
		// по array
		if (isset($this->request->post['product_related_array'])) {
			$products = $this->request->post['product_related_array'];
		} elseif (isset($this->request->get['product_id'])) {
			$products = $this->model_catalog_product->getProductRelatedArray($this->request->get['product_id']);
		} else {
			$products = array();
		}
		$data['product_relateds_array'] = array();
		foreach ($products as $product_id) {
			$related_info = $this->model_catalog_product->getProduct($product_id);
