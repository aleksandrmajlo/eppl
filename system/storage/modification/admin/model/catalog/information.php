...
class ModelCatalogInformation extends Model {
	...
	public function editInformation($information_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "seo_url WHERE route='information/information' AND query = 'information_id=" . (int)$information_id . "'");
	...
	public function getInformationSeoUrls($information_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "seo_url WHERE route='information/information' AND query = 'information_id=" . (int)$information_id . "'");
