...
class ModelCatalogCategory extends Model {
	...
	public function editCategory($category_id, $data) {
		...
		// SEO URL
		$this->db->query("DELETE FROM `" . DB_PREFIX . "seo_url` WHERE route = 'product/category' AND query = 'category_id=" . (int)$category_id . "'");
	...
	public function getCategorySeoUrls($category_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "seo_url WHERE route = 'product/category' AND query = 'category_id=" . (int)$category_id . "'");
