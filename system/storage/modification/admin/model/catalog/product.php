...
class ModelCatalogProduct extends Model {
    ...
    // OCFilter start
		...
		// по цвету
		if (isset($data['product_related_color'])) {
			foreach ($data['product_related_color'] as $related_id) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_related_color WHERE product_id = '" . (int)$product_id . "' AND related_id = '" . (int)$related_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_related_color SET product_id = '" . (int)$product_id . "', related_id = '" . (int)$related_id . "'");
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_related_color WHERE product_id = '" . (int)$related_id . "' AND related_id = '" . (int)$product_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_related_color SET product_id = '" . (int)$related_id . "', related_id = '" . (int)$product_id . "'");
			}
		}

		// по array
		if (isset($data['product_related_array'])) {
			foreach ($data['product_related_array'] as $related_id) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_related_array WHERE product_id = '" . (int)$product_id . "' AND related_id = '" . (int)$related_id . "'");
    ...
    $this->db->query("DELETE FROM " . DB_PREFIX . "ocfilter_option_value_to_product WHERE product_id = '" . (int)$product_id . "'");
		...
		// SEO URL
		$this->db->query("DELETE FROM " . DB_PREFIX . "seo_url WHERE route='product/product' AND query = 'product_id=" . (int)$product_id . "'");
	...
	public function getProductSeoUrls($product_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "seo_url WHERE route='product/product' AND query = 'product_id=" . (int)$product_id . "'");
	...
	public function getProductRelatedColor($product_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_related_color WHERE product_id = '" . (int)$product_id . "'");
