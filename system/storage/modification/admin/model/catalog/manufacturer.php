...
class ModelCatalogManufacturer extends Model {
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		$this->db->query("DELETE FROM `" . DB_PREFIX . "seo_url` WHERE route='product/manufacturer/info' AND query = 'manufacturer_id=" . (int)$manufacturer_id . "'");
	...
	public function getManufacturerSeoUrls($manufacturer_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "seo_url WHERE route='product/manufacturer/info' AND query = 'manufacturer_id=" . (int)$manufacturer_id . "'");
